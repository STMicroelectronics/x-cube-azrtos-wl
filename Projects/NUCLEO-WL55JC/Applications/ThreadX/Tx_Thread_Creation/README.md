...
The 'ThreadOne' starts to toggle the 'GREEN LED' each 500ms while 'ThreadTwo' cannot, as its priority is less than the 'ThreadOne' threshold.
After 5 seconds, it sends an event 'THREAD_ONE_EVT' to the 'MainThread'.
...
Now, the 'ThreadTwo' can preempt the 'ThreadOne' and starts toggling the 'LED_GREEN' each 200ms for 5 seconds. Once done, it sends the 'THREAD_TWO_EVT' to 'MainThread'.
...
After repeating the sequence above 3 times, the 'MainThread' should destroy 'ThreadOne' and 'ThreadTwo' and toggle the 'GREEN LED' each 1 second for ever.

####  <b>Expected success behavior</b>

  - GREEN LED toggles every 500ms for 5 seconds
  - GREEN LED toggles every 200ms for 5 seconds
  - Success status (After 3 times) :  GREEN LED toggles every 1 second for ever.

#### <b>Error behaviors</b>

On failure, an error message is printed to the serial port while GREEN LED is switched OFF.
